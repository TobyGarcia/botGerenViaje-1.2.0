...
import {
  finalizeTurnController,
  getAssignedVehicleTurnStatusController,
  getTurnHistoryController,
  startTurnController
} from "../controllers/turnos-vehiculo.controller.js";
...
router.get("/turnos/mi-unidad", getAssignedVehicleTurnStatusController);
router.post("/turnos/finalizar", finalizeTurnController);
router.post("/turnos/iniciar", startTurnController);
router.get("/turnos/historial/:idVehiculo", getTurnHistoryController);
